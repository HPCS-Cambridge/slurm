/*****************************************************************************\
 *  task_cgroup_blkio.h - memory cgroup subsystem primitives for task/cgroup
 *****************************************************************************
 *  Copyright (C) 2009 CEA/DAM/DIF
 *  Based on task_cgroup_memory.h by Matthieu Hautreux <matthieu.hautreux@cea.fr>
 *
 *  TODO own (C)?
 *
...
#ifndef _TASK_CGROUP_BLKIO_H_
#define _TASK_CGROUP_BLKIO_H_
...
extern int task_cgroup_blkio_check_oom(stepd_step_rec_t *job);
